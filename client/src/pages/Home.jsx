...
function Home() {
    return (
        <div className="flex flex-col items-center justify-center bg-[#FF3F33] h-screen px-6 py-12 text-center gap-6 space-y-6">
            ...
            <Link to="/AddBlog">
                <button className="bg-white text-red-500 font-semibold text-lg px-6 py-3 rounded-full shadow-md hover:bg-[#FED16A] hover:text-white transition duration-300">
                    ✍️ Write a Blog
                </button>
            </Link>
        </div>
